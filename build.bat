...
python -m PyInstaller ^
    ...
    --hidden-import "src.conversion_strategies" ^
    --hidden-import "src.division_parser" ^
    --hidden-import "src.lark_data_parser" ^
    --hidden-import "src.lark_procedure_parser" ^
    --hidden-import "src.gui_model" ^
    --hidden-import "src.gui_view" ^
    --hidden-import "src.gui_controller" ^
    main.py
